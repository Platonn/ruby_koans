...
class AboutMessagePassing < Neo::Koan
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # method_missing like that after Ruby 1.9 normally. - aha, no chyba ze tak :)
    #
...
#Troche nie zrozumialem tego cwiczenia, szczegolnie z tym wyluskiwaniem "foo" z poczatku
